...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "naristi@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "naristi API";

        private String description = "naristi API documentation";
